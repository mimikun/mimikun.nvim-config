...
---@type table
local _smooth_cursor_without_smear = require("plugins.smear-cursor-nvim.opts.smooth-cursor-without-smear")

---@type table
local _faster = require("plugins.smear-cursor-nvim.opts.faster")

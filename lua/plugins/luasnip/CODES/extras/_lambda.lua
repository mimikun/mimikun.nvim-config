...
lambda._1, lambda._2, lambda._3, lambda._4, lambda._5 = PH(1), PH(2), PH(3), PH(4), PH(5)
...
function lambda.instantiate(e)
  ...
  rep = repr(e)
  local fstr = ("return function(%s) return function(args) return %s end end"):format(consts, rep)
  if _DEBUG then
    print(fstr)
  end

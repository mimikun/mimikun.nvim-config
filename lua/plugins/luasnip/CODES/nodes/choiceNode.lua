...
ChoiceNode.init_insert_positions =
  node_util.init_child_positions_func("absolute_insert_position", "choices", "init_insert_positions")
...
function ChoiceNode:set_choice(choice, current_node, cursor_restore_data)
  ...
  self.active_choice.mark = self.mark:copy_pos_gravs(vim.deepcopy(self.active_choice:get_passive_ext_opts()))

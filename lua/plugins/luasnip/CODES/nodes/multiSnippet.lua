...
local function multisnippet_from_snippet_obj(contexts, snippet, snippet_opts)
  ...
  for _, context in ipairs(contexts) do
    ...
    table.insert(v_snips, new_virtual_snippet(complete_context, snippet, snippet_opts))
  end
...
local function multisnippet_from_nodes(contexts, nodes, opts)
  ...
  return multisnippet_from_snippet_obj(
    contexts,
    snip_mod._S(snip_mod.init_snippet_opts(common_snip_opts), nodes, common_snip_opts),
    common_snip_opts
  )
end

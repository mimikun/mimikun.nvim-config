...
function M.x()
  normal_mode_delete_yank_and_feedkeys("x")
end
function M.X()
  normal_mode_delete_yank_and_feedkeys("X")
end
function M.dd()
  normal_mode_delete_yank_and_feedkeys("dd")
end
function M.D()
  normal_mode_delete_yank_and_feedkeys("D")
end
function M.yy()
  normal_mode_delete_yank_and_feedkeys("yy")
end
...
function M.d()
  normal_mode_delete_yank_and_feedkeys_with_motion("d")
end
function M.y()
  normal_mode_delete_yank_and_feedkeys_with_motion("y")
end
...
function M.p()
  normal_mode_put_and_feedkeys("p")
end
function M.P()
  normal_mode_put_and_feedkeys("P")
end

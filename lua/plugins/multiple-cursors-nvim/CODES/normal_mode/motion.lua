...
function M.k()
  normal_command_and_feedkeys("k")
end
function M.j()
  normal_command_and_feedkeys("j")
end
function M.minus()
  normal_command_and_feedkeys("-")
end
function M.plus()
  normal_command_and_feedkeys("+")
end
function M.underscore()
  normal_command_and_feedkeys("_")
end

function M.h()
  normal_command_and_feedkeys("h")
end
function M.l()
  normal_command_and_feedkeys("l")
end
function M.zero()
  normal_command_and_feedkeys("0")
end
function M.caret()
  normal_command_and_feedkeys("^")
end
...
function M.w()
  normal_command_and_feedkeys("w")
end
function M.W()
  normal_command_and_feedkeys("W")
end
function M.e()
  normal_command_and_feedkeys("e")
end
function M.E()
  normal_command_and_feedkeys("E")
end
function M.b()
  normal_command_and_feedkeys("b")
end
function M.B()
  normal_command_and_feedkeys("B")
end
function M.ge()
  normal_command_and_feedkeys("ge")
end
function M.gE()
  normal_command_and_feedkeys("gE")
end

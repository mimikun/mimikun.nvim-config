...
function M.trimmed_lines(content, old_text)
  ...
  for i = 1, #content_lines - #search_lines + 1 do
    ...
    for j = 1, #search_lines do
      ...
      elseif
        tool_utils.similarity_score(content_line, search_line)
        >= constants.CONFIDENCE.SIMILARITY_THRESHOLD_MEDIUM
      then
...
local function get_all_strategies()
  return {
    ...
    },
    {
      ...
      func = M.position_markers,
      min_confidence = constants.CONFIDENCE.POSITION_MARKERS,
    },

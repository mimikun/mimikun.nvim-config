...
editor.update_winpos = function()
  ...
  local coords = window_coords(vim.api.nvim_buf_get_lines(editor.buffer, 0, -1, false))
...
editor.edit = function()
  ...
  while node do
    if edit_conf[node:type()] then
      ...
      ---@type string[], string, integer[]
      editor.e_cache.lines, editor.e_cache.ft, editor.e_cache.range =
        editor.e_cache.node_config.parser(editor.e_cache.source, node)
      editor.open_editor()
      break
    end
...
editor.create_block = function()
  ...
  if editor.c_cache.node_config.formatter then
    lines = editor.c_cache.node_config.formatter(editor.c_cache.source, range, lines)
  end
...
editor.create = function()
  ...
  editor.c_cache.delimiters, editor.c_cache.ft, editor.c_cache.range =
    editor.c_cache.node_config.init(editor.c_cache.source)
  editor.open_creator()
end

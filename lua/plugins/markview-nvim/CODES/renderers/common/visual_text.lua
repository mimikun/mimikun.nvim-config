...
local image = lpeg.C(lpeg.P("![") * image_label_char ^ 0 * lpeg.P("](") * image_link_char ^ 0 * lpeg.P(")"))
  / visual.md_labeled_link

local link_label_char = lpeg.P("\\]") + (1 - lpeg.P("]"))
local link_link_char = lpeg.P("\\)") + (1 - lpeg.P(")"))
local link = lpeg.C(lpeg.P("[") * link_label_char ^ 0 * lpeg.P("](") * link_link_char ^ 0 * lpeg.P(")"))
  / visual.md_labeled_link

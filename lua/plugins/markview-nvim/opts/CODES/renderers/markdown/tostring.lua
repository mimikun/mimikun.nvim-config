...
local s_bold_italic = lpeg.C(flank_open(lpeg.P("*") ^ 3) * s_bold_italic_content ^ 1 * flank_close(lpeg.P("*") ^ 3))
  / md_str.bold_italic
...
local hyperlink_src = lpeg.C(
  lpeg.P("[") * hyperlink_content ^ 0 * lpeg.P("](") * space ^ 0 * src_content ^ 0 * space ^ 0 * lpeg.P(")")
...
local img_src = lpeg.C(
  lpeg.P("![") * img_content ^ 0 * lpeg.P("](") * space ^ 0 * src_content ^ 0 * space ^ 0 * lpeg.P(")")
) / md_str.img_src

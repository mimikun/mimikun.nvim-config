<!--markdoc
    {
        "generic": {
            "filename": "../doc/markview.nvim-asciidoc_inline.txt",
            "force_write": true,
            "header": {
                "desc": "🧩 Inline asciidoc options for `markview.nvim`",
                "tag": "markview.nvim-asciidoc_inline"
            }
        },
        "asciidoc": {
            "heading_ratio": [ 26, 54 ],
            ...
            "tags": {
                "enable": [ "markview.nvim-asciidoc_inline.enable" ],
                "bolds": [ "markview.nvim-asciidoc_inline.bolds" ],
                "highlights": [ "markview.nvim-asciidoc_inline.highlights" ],
                "italics": [ "markview.nvim-asciidoc_inline.italics" ],
                "monospaces": [ "markview.nvim-asciidoc_inline.monospaces" ],
                "uris": [ "markview.nvim-asciidoc_inline.uris" ]
            }
        }
    }
-->

<!--markdoc
    {
        ...
        "markdown": {
            ...
            "link_url_modifiers": [
                [ "Experimental#fancy_comments$", "`markview.nvim-experimental.fancy_comments`" ],
                [ "Experimental#file_open_command$", "`markview.nvim-experimental.file_open_command`" ],
                [ "Experimental#prefer_nvim$", "`markview.nvim-experimental.prefer_nvim`" ],
...
- Allow going to headings(fragment links) with Github-style section links(e.g. [🧩 Preview options](#-preview-options))
    + Allow going to headings in other files when [experimental.prefer_nvim](https://github.com/OXY2DEV/markview.nvim/wiki/Experimental#prefer_nvim) is set to `true`.
- Allow opening **text files** within Neovim when [experimental.prefer_nvim](https://github.com/OXY2DEV/markview.nvim/wiki/Experimental#prefer_nvim) is set to `true` using [experimental.file_open_command](https://github.com/OXY2DEV/markview.nvim/wiki/Experimental#file_open_command).

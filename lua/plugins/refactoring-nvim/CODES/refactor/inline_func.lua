...
local function get_processed_match(definitions, references, lang)
  ...
  if not function_query then
    return query_error("refactor_function", lang)
  end
  local function_call_query = ts.query.get(lang, "refactor_function_call")
  if not function_call_query then
    return query_error("refactor_function_call", lang)
  end
          ...
          local function_for_return = iter(match.functions)
            ...
            :fold(
              ...
              function(acc, function_)
                ...
                if function_["function"]:byte_length() < acc["function"]:byte_length() then
                  return function_
                end
                return acc
              end
            )
          if not function_for_return then
            return
          end
...
function M.inline_func(_, config)
  ...
  if not get_assignment then
    return code_gen_error("assignment", lang)
  end
  ...
  local task = async.run(function()
    ...
    if not definition_with_function then
      return
    end

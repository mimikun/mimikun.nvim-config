...
local function render_timeline()
  ...
  local tl_lines, tl_highlights = timeline_mod.render_aligned(board.state, board.dims.timeline_w)
  ...
  for _, hl in ipairs(tl_highlights) do
    vim.api.nvim_buf_add_highlight(board.bufs.timeline, ns, hl.hl, hl.line, hl.col_start, hl.col_end)
  end
end
...
local function setup_keymaps(buf)
  ...
  vim.keymap.set("n", "w", function()
    set_timeline_scale("w")
  end, opts)
  vim.keymap.set("n", "m", function()
    set_timeline_scale("m")
  end, opts)

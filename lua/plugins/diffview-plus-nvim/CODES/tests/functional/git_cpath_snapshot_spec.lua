  ...
  it(
    ...
    test_utils.async_test(function()
      ...
      local ok, err = pcall(function()
        ...
        assert.same({ "--git-dir=" .. env.store, "--work-tree=" .. env.project }, adapter.ctx.git_override)
  ...
  it(
    ...
    test_utils.async_test(function()
      ...
      local ok, err = pcall(function()
        ...
        assert.same({ "line1", "line2-A", "line3-B", "line4-local" }, vim.api.nvim_buf_get_lines(bufnr, 0, -1, false))
      end)

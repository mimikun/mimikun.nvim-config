...
function Rev:init(rev_type, revision, track_head)
  ...
  assert(revision == nil or t == "string" or t == "number", "'revision' must be one of: nil, string, number!")
  if t == "string" then
...
function M.same_rev(a, b)
  ...
  return a.type == b.type and a.commit == b.commit and a.stage == b.stage and a.track_head == b.track_head
end

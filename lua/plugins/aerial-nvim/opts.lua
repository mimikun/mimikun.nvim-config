...
local opts = {
  ...
  layout = {
    ...
    -- The 'prefer' options will open the window in the other direction *if* there is a different buffer in the way of the preferred direction
    ---@type string | "prefer_right" | "prefer_left" | "right" | "left" | "float"
    default_direction = "prefer_right",

    -- Determines where the aerial window will be opened
    -- edge   - open aerial at the far right/left of the editor
    -- window - open aerial to the right/left of the current window
    ---@type string | "edge" | "window"
    placement = "window",
  ...
  -- Can be any value that `vim.keymap.set` accepts OR a table of keymap options with a `callback` (e.g. { callback = function() ... end, desc = "", nowait = true })
  ...
  ---@type string | "split_width" | "full_width" | "last" | "none"
  ...
  ignore = {
    ...
    -- table        - A list of buftypes to ignore.
    --              - See :help buftype for the possible values.
    -- function     - A function that returns true if the buffer should be ignored or false if it should not be ignored.
    --                Takes two arguments, `bufnr` and `buftype`.
    ---@type string | "special" | false | nil | table | func
    buftypes = "special",
    ...
    -- table        - A list of wintypes to ignore.
    --              - See :help win_gettype() for the possible values.
    -- function     - A function that returns true if the window should be ignored or false if it should not be ignored.
  ...
  float = {
    ...
    ---@type string | "cursor" | "editor" | "win"
    relative = "cursor",

    -- These control the height of the floating window.
    -- They can be integers or a float between 0 and 1 (e.g. 0.4 for 40%) min_height and max_height can be a list of mixed types.

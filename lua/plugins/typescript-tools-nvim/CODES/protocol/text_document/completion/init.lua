...
function M.handler(request, response, params)
  ...
  request({
    ...
    arguments = vim.tbl_extend("force", {
      ...
      triggerCharacter = vim.tbl_contains(c.CompletionsTriggerCharacter, trigger_character) and trigger_character
        or nil,
  ...
  vim.schedule(function()
    ...
    response({
      ...
      items = vim.tbl_map(function(item)
        local is_optional = item.kindModifiers and string.find(item.kindModifiers, "optional", 1, true) or false
        local is_deprecated = item.kindModifiers and string.find(item.kindModifiers, "deprecated", 1, true) or false
        ...
        return {
          ...
          kind = kind,
          insertTextFormat = should_create_snippet and c.InsertTextFormat.Snippet or c.InsertTextFormat.PlainText,
          sortText = sortText,

...
function M.handler(request, response, params)
  local command = params.context and params.context.source_definition and c.CommandTypes.FindSourceDefinition
  ...
  local origin_selection_range = body.textSpan and utils.convert_tsserver_range_to_lsp(body.textSpan) or nil

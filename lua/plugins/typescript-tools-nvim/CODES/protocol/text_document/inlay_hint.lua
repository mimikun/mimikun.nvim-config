...
function M.handler(request, response, params)
  ...
  local start_offset =
    utils.get_offset_at_position({ params.range.start.line, params.range.start.character }, requested_bufnr)
  local end_offset =
    utils.get_offset_at_position({ params.range["end"].line, params.range["end"].character }, requested_bufnr)

## Advanced shortcuts for frequently used queries [#756](https://github.com/yetone/avante.nvim/pull/756)

> [!NOTE]
> It also use `which-key.nvim` for convenience, but this works the same with `vim.keymap.set`

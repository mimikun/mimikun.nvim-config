...
function H.keymaps()
  ...
  vim.keymap.set({ "n", "v" }, "<Plug>(AvanteAskNew)", function()
    require("avante.api").ask({ new_chat = true })
  end, { noremap = true })
  vim.keymap.set({ "n", "v" }, "<Plug>(AvanteChat)", function()
    require("avante.api").ask({ ask = false })
  end, { noremap = true })
  vim.keymap.set({ "n", "v" }, "<Plug>(AvanteZenMode)", function()
  ...
  vim.keymap.set("n", "<Plug>(AvanteStop)", function()
    require("avante.api").stop()
  end, { noremap = true })
  vim.keymap.set("n", "<Plug>(AvanteRefresh)", function()
    require("avante.api").refresh()
  end, { noremap = true })
  vim.keymap.set("n", "<Plug>(AvanteFocus)", function()
    require("avante.api").focus()
  end, { noremap = true })
  vim.keymap.set("n", "<Plug>(AvanteBuild)", function()
  ...
  vim.keymap.set("n", "<Plug>(AvanteToggleSelection)", function()
    M.toggle.selection()
  end)
  vim.keymap.set("n", "<Plug>(AvanteToggleSuggestion)", function()
    M.toggle.suggestion()
  end)
  ...
  vim.keymap.set("n", "<Plug>(AvanteSelectModel)", function()
    require("avante.api").select_model()
  end)
  vim.keymap.set("n", "<Plug>(AvanteSelectHistory)", function()
    require("avante.api").select_history()
  end)
  vim.keymap.set("n", "<Plug>(AvanteSelectACPModel)", function()
    require("avante.api").select_acp_model()
  end, {
    noremap = true,
  })
  vim.keymap.set("n", "<Plug>(AvanteSelectACPMode)", function()
    require("avante.api").select_acp_mode()
  end, {
    noremap = true,
  })
  vim.keymap.set("n", "<Plug>(AvanteShowRepoMap)", function()
    require("avante.repo_map").show()
  end, {
    noremap = true,
    silent = true,
  })
  vim.keymap.set("n", "<Plug>(AvanteAddAllBuffers)", function()
...
function H.autocmds()
  api.nvim_create_autocmd("TabEnter", {
    ...
    callback = function(ev)
      ...
      if Config.selection.enabled and not M.current.selection.did_setup then
...
M.toggle.selection = H.api(Utils.toggle_wrap({
  name = "selection",
  get = function()
    return Config.selection.enabled
  end,
  set = function(state)
    Config.override({ selection = { enabled = state } })
  end,
}))
...
M.toggle.suggestion = H.api(Utils.toggle_wrap({
  name = "suggestion",
  get = function()
    return Config.behaviour.auto_suggestions
  end,
  set = function(state)
...
function M.setup(opts)
  ...
  if Config.rag_service.enabled then
    require("avante.rag_service").run_rag_service()
  end

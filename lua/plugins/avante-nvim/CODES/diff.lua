...
function H.setup_buffer_mappings(bufnr)
  ...
  vim.keymap.set({ "n", "v" }, Config.mappings.diff.both, function()
    M.choose("both")
  end, opts("choose both"))
  vim.keymap.set({ "n", "v" }, Config.mappings.diff.theirs, function()
    M.choose("theirs")
  end, opts("choose theirs"))
  vim.keymap.set({ "n", "v" }, Config.mappings.diff.all_theirs, function()
    M.choose("all_theirs")
  end, opts("choose all theirs"))
  vim.keymap.set("n", Config.mappings.diff.cursor, function()
    M.choose("cursor")
  end, opts("choose under cursor"))
  vim.keymap.set("n", Config.mappings.diff.prev, function()
    M.find_prev("ours")
  end, opts("previous conflict"))
  vim.keymap.set("n", Config.mappings.diff.next, function()
    M.find_next("ours")

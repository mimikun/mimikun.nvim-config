  ...
  format = function(self, ctx, lines, callback)
    ...
    for i, region in ipairs(regions) do
      ...
      if end_lnum < last_start_lnum then
        ...
        local formatters = conform.resolve_formatters(ft_formatters, ctx.buf, false, stop_after_first)
        ...
        local buf = vim.fn.bufadd(string.format("%s.%d.%s", vim.api.nvim_buf_get_name(ctx.buf), i, extension))

...
function M.setup()
  if M.provider_name then
    return true
  end
  if M.setup_failed then
    return false
  end
...
function M.get_icon(filename, extension, is_directory)
  ...
  if is_directory then
    return M.get_directory_icon(filename)
  end
...
function M.supports_directories()
  return M.setup() and M.provider_name ~= nil
end

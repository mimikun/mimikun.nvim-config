...
local opts = {
  ...
  ---@type string | "modern" | "classic" | "minimal" | "powerline" | "ghost" | "simple" | "nonerdfont" | "amongus"
  preset = "modern",

  -- XXX: Use presets or signs and blend
  ...
  options = {
    ...
    -- When using display_count = true, you need to enable multiline diagnostics with multilines.enabled = true

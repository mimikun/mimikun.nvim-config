...
module.public = {
  ...
  set_workspace = function(ws_name)
    ...
    modules.broadcast_event(
      assert(
        modules.create_event(module, "core.dirman.events.workspace_changed", { old = current_ws, new = new_workspace })
      )
    )
  ...
  set_last_workspace = function()
    ...
    last_workspace = type(last_workspace) == "string" and last_workspace or module.public.get_default_workspace() or ""

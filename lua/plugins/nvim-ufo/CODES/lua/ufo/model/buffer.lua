...
function Buffer:attach()
  ...
  self.attached = api.nvim_buf_attach(self.bufnr, false, {
    on_lines = function(name, bufnr, changedtick, firstLine, lastLine, lastLineUpdated, byteCount)
      ...
      event:emit("BufLinesChanged", bufnr, changedtick, firstLine, lastLine, lastLineUpdated, byteCount)
    end,

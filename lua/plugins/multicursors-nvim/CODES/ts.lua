...
local same_range = function(a, b)
  return a.col == b.col and a.row == b.row and a.end_col == b.end_col and a.end_row == b.end_row
end
...
local get_node_range = function(node)
  ---@type Selection
  local node_range = {}
  node_range.row, node_range.col, node_range.end_row, node_range.end_col = node:range()
  return node_range
end

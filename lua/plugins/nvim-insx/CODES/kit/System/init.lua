...
---@class insx.kit.System.DelimiterBuffering: insx.kit.System.Buffering
...
function System.spawn(command, params)
  ...
  local close --[[@type fun(signal?: integer): insx.kit.Async.AsyncTask]]

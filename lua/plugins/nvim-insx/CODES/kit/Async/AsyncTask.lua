...
---@class insx.kit.Async.AsyncTask
---@field private value any
---@field private status insx.kit.Async.AsyncTask.Status
...
---@param status insx.kit.Async.AsyncTask.Status
---@param value any
...
---@enum insx.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: insx.kit.Async.AsyncTask.Status, value: any }

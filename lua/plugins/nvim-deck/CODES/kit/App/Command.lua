---@class deck.kit.App.Command.SubCommand.Argument
---@field public complete? fun(prefix: string):string[]
---@field public required? boolean

---@class deck.kit.App.Command.SubCommandSpecifier
---@field public desc? string
---@field public args? table<string|number, deck.kit.App.Command.SubCommand.Argument>
---@field public execute fun(params: deck.kit.App.Command.ExecuteParams, arguments: table<string, string>)

---@class deck.kit.App.Command.SubCommand: deck.kit.App.Command.SubCommandSpecifier
---@field public name string
---@field public args table<string|number, deck.kit.App.Command.SubCommand.Argument>

---@class deck.kit.App.Command
---@field public name string
---@field public subcommands table<string, deck.kit.App.Command.SubCommand>
local Command = {}
Command.__index = Command

---Create a new command.
---@param name string
---@param subcommand_specifiers table<string, deck.kit.App.Command.SubCommandSpecifier>
...
---@class deck.kit.App.Command.ExecuteParams
---@field public name string
...
---Execute command.
---@param params deck.kit.App.Command.ExecuteParams

...
local Cache = require("deck.kit.App.Cache")

---@class deck.kit.App.Config.Schema

---@alias deck.kit.App.Config.SchemaInternal deck.kit.App.Config.Schema|{ revision: integer }

---@class deck.kit.App.Config
---@field private _cache deck.kit.App.Cache
---@field private _default deck.kit.App.Config.SchemaInternal
---@field private _global deck.kit.App.Config.SchemaInternal
---@field private _filetype table<string, deck.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, deck.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default deck.kit.App.Config.Schema
...
---@param config deck.kit.App.Config.Schema
...
---@return deck.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: deck.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: deck.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: deck.kit.App.Config.Schema) }

...
---@class deck.kit.RPC.JSON.Transport
---@field send fun(self: deck.kit.RPC.JSON.Transport, data: table): deck.kit.Async.AsyncTask
---@field on_message fun(self: deck.kit.RPC.JSON.Transport, callback: fun(data: table))
...
---@class deck.kit.RPC.JSON.RPC
---@field private _transport deck.kit.RPC.JSON.Transport
...
---@param params { transport: deck.kit.RPC.JSON.Transport }

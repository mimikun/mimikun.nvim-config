---@alias deck.kit.Vim.WinSaveView.Signature deck.kit.Vim.WinSaveView.Signature.Branch | deck.kit.Vim.WinSaveView.Signature.Leaf
---@alias deck.kit.Vim.WinSaveView.Signature.Branch { [1]: 'row' | 'col', [2]: deck.kit.Vim.WinSaveView.Signature.Leaf[] }
---@alias deck.kit.Vim.WinSaveView.Signature.Leaf { [1]: 'leaf' }

---@alias deck.kit.Vim.WinSaveView.Dimension table<number, { width: number, height: number }>

---Get a size related window layout information.
---@return deck.kit.Vim.WinSaveView.Dimension, deck.kit.Vim.WinSaveView.Signature[]
local function get_win_dimensions_and_signatures()
  ---@type deck.kit.Vim.WinSaveView.Dimension
  local dimensions = {}
...
---@class deck.kit.Vim.WinSaveView
---@field private _mode string
---@field private _view table
---@field private _win number
---@field private _cur table
---@field private _dimensions deck.kit.Vim.WinSaveView.Dimension
---@field private _signatures deck.kit.Vim.WinSaveView.Signature[]
local WinSaveView = {}

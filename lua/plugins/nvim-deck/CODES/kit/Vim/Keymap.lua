...
local resolve_key =
  vim.api.nvim_replace_termcodes('<Cmd>lua require("deck.kit.Vim.Keymap")._resolve(%s)<CR>', true, true, true)

---@alias deck.kit.Vim.Keymap.Keys { keys: string, remap?: boolean }
---@alias deck.kit.Vim.Keymap.KeysSpecifier string|deck.kit.Vim.Keymap.Keys

---@param keys deck.kit.Vim.Keymap.KeysSpecifier
---@return deck.kit.Vim.Keymap.Keys
...
function Keymap.normalize(s)
  local desc = "deck.kit.Vim.Keymap.normalize"
...
---Send keys.
---@param keys deck.kit.Vim.Keymap.KeysSpecifier|deck.kit.Vim.Keymap.KeysSpecifier[]

...
---@enum deck.kit.IO.UV.AccessMode
IO.AccessMode = {
  r = "r",
  rs = "rs",
  sr = "sr",
...
---@param start_path string
---@param callback fun(err: string|nil, entry: { path: string, type: string }): deck.kit.IO.WalkStatus?

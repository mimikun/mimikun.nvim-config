              ...
              actions = {
                {
                  ...
                  execute = function(branch_ctx)
                    ...
                    Async.run(function()
                      ...
                      local local_name = vim.fn.input(
                        ("branching from: %s/%s\nnew branch name: "):format(branch.remotename, branch.name),
                        branch.name
                      )
                      if local_name == "" then
                        return
                      ...
                      local worktree_path =
                        vim.fn.input("worktree path: ", misc.get_default_worktree_path(git, local_name))

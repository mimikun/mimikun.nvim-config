    ...
    execute = function(ctx)
      Async.run(function()
        ...
        while true do
          ...
          local logs =
            git:log({ count = chunk, offset = offset, paths = option.paths, rev_range = option.rev_range }):await() ---@type deck.x.Git.Log[]
            ...
            require("deck.builtin.source.items")({
              {
                ...
                actions = { yank_action(function(i)

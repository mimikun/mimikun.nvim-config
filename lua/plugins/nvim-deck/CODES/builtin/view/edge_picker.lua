  ...
  view = {
    ...
    show = function(ctx)
      ...
      do
        local function update_window_size()
          ...
          local curr_height_or_width = split == "horizontal" and vim.api.nvim_win_get_height(state.win)
            or vim.api.nvim_win_get_width(state.win)
    ...
    open_preview_win = function(ctx)
      ...
      local win_config = {
        ...
        row = math.max(1, math.floor(available_height * 0.1) - 2) + (position == "top" and height_or_width or 0),

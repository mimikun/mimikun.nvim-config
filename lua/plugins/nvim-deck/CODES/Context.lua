...
function Context.create(id, source, start_config, prev)
  ...
  do
    local parsed = source.parse_query and source.parse_query(start_config.query or "")
      or {
        dynamic_query = "",
  ...
  context = {
    ...
    show = function()
      ...
      state.redraw_timer:start(
        start_config.performance.redraw_tick_ms,
        start_config.performance.redraw_tick_ms,
        function()
    ...
    set_query = function(query)
      ...
      local parsed = source.parse_query and source.parse_query(query)
        or {
          dynamic_query = "",
          matcher_query = query,
        }

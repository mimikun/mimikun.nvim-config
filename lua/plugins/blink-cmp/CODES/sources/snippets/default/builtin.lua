...
builtin.lazy.TM_FILENAME = cached(function()
  return vim.fn.expand("%:t")
end)
builtin.lazy.TM_FILENAME_BASE = cached(function()
  return vim.fn.expand("%:t:s?\\.[^\\.]\\+$??")
end)
builtin.lazy.TM_DIRECTORY = cached(function()
  return vim.fn.expand("%:p:h")
end)
builtin.lazy.TM_FILEPATH = cached(function()
...
builtin.lazy.LINE_COMMENT = cached(function()
  return buffer_comment_chars()[1]
end)
builtin.lazy.BLOCK_COMMENT_START = cached(function()
  return buffer_comment_chars()[2]
end)
builtin.lazy.BLOCK_COMMENT_END = cached(function()

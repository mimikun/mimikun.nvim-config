...
function completion.get_completion_for_client(context, client, opts)
  ...
  if cache_entry ~= nil then
    return task.resolve(cache_entry)
  end
  ...
  return request(context, client):map(function(res)
    ...
    if client.name == "clangd" then
      require("blink.cmp.sources.lsp.hacks.clangd").process_response(response)
    end
    if client.name == "lua_ls" then
      require("blink.cmp.sources.lsp.hacks.lua_ls").process_response(response)
    end

...
---@param byte integer
---@return boolean
function char.is_upper(byte)
  return ALPHA[byte]
end

---@param byte integer
---@return boolean
function char.is_alpha(byte)
  return alpha[byte] or ALPHA[byte]
end

---@param byte integer
---@return boolean
function char.is_digit(byte)
  return digit[byte]
end

---@param byte integer
---@return boolean
function char.is_white(byte)
  return white[byte]
end

---@param byte integer
---@return boolean
function char.is_symbol(byte)
  return not (char.is_alnum(byte) or char.is_white(byte))
end

---@param byte integer
---@return boolean
function char.is_alnum(byte)

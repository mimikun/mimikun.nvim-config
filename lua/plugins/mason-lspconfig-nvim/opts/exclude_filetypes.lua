...
-- codebook (spell check) and harper_ls (english grammar) both claim markdown and both report the same project nouns -- `kiro`, `SDLC`, `subagent`, `md` -- as misspellings, so a markdown buffer opens with dozens of duplicated INFO/HINT diagnostics and effectively no signal.

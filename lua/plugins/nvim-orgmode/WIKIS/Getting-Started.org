...
* File Syntax
  ...
  add new list items by pressing `<Leader><Enter>`, the so-called org `meta
  return`. It has different effects, depending on the current position of the
...
* Basic Customization
  ...
  All available options are detailed [[https://github.com/nvim-orgmode/orgmode/blob/master/DOCS.md][here]], including setting new keybindings.
...
* Captures
  ...
  Here we are presented with a list of available capture templates.
  ...
  possible ways to
  [[https://github.com/nvim-orgmode/orgmode/blob/master/DOCS.md#org_capture_templates][configure your templates]].
...
* Archiving
  ...
  [[https://github.com/nvim-orgmode/orgmode/blob/master/DOCS.md#org_archive_location][org_archive_location]]
  option.

* Exporting

  In case you want to preview, you can export your .org file to e.g., html with pandoc, see the [[https://github.com/nvim-orgmode/orgmode/blob/master/DOCS.md#org_export][docs]].

* Further Resources

  Our Docs can be found [[https://github.com/nvim-orgmode/orgmode/blob/master/DOCS.md][here]]
  ...
  [[https://github.com/nvim-orgmode/orgmode#development][get
  your hands dirty]] and create a pull request :wink:
...
local function setup_tabpage(tabpage)
  ...
  view_state.Active.tabpages[tabpage] =
    vim.tbl_extend("force", view_state.Active.tabpages[tabpage] or tabinitial, { winnr = winnr })
end
...
local function grow()
  local starts_at = (M.is_root_folder_visible(require("nvim-tree.core").get_cwd()) and view_state.Active.root_excluded)
      and 1
    or 0

...
function M.apply(config, is_default)
  ...
  vim.api.nvim_set_hl(0, "DiffsRailNr", { default = dflt, fg = line_nr_fg, bg = bg, nocombine = true })
  vim.api.nvim_set_hl(0, "DiffsAddRailNr", { default = dflt, fg = add_fg, bg = blended_add, nocombine = true })
  vim.api.nvim_set_hl(0, "DiffsDeleteRailNr", { default = dflt, fg = del_fg, bg = blended_del, nocombine = true })
  ...
  vim.api.nvim_set_hl(0, "DiffsDiffDelete", { default = dflt, fg = diff_delete.fg, bg = diff_delete.bg })
  ...
  vim.api.nvim_set_hl(0, "DiffsConflictOursNr", { default = dflt, fg = blended_ours_nr, bg = blended_ours })
  vim.api.nvim_set_hl(0, "DiffsConflictTheirsNr", { default = dflt, fg = blended_theirs_nr, bg = blended_theirs })
  vim.api.nvim_set_hl(0, "DiffsConflictBaseNr", { default = dflt, fg = blended_base_nr, bg = blended_base })

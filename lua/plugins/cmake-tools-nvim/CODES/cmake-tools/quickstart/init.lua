...
local generate_cmakelists_file = function()
  local file_name = base_path .. "templates/" .. locals.type .. "/" .. locals.language .. "/CMakeLists.txt.etlua"
...
local generate_main_file = function()
  local file_name = base_path .. "templates/" .. locals.type .. "/" .. locals.language .. "/main.etlua"
  local file = io.open(file_name, "r")
  if not file then
    error("could not find file: " .. file_name)
    return

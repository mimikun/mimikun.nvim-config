...
local function createContext(options)
  ...
  local context = {
    ...
    extmarkIds = {},
    actions = {},
    fileIconsProvider = options.icons.enabled and require("grug-far.fileIconsProvider").getProvider(
...
function grug_far.update_instance_prefills(instQuery, prefills, clearOld)
  vim.deprecate("update_instance_prefills(...)", "get_instance(...):update_input_values()", "soon", "grug-far.nvim")
...
function grug_far.goto_first_input(instQuery)
  vim.deprecate("goto_first_input(...)", "get_instance(...):goto_first_input()", "soon", "grug-far.nvim")
...
function grug_far.goto_next_input(instQuery)
  vim.deprecate("goto_next_input(...)", "get_instance(...):goto_next_input()", "soon", "grug-far.nvim")
...
function grug_far.goto_prev_input(instQuery)
  vim.deprecate("goto_prev_input(...)", "get_instance(...):goto_prev_input()", "soon", "grug-far.nvim")

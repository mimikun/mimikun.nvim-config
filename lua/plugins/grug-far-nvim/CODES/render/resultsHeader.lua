...
local function getSeparator(context)
  ...
  if context.options.showEngineInfo then
    ...
    local interpreter_type = context.replacementInterpreter and context.replacementInterpreter.type or nil
  ...
  local statusText = context.options.showStatusIcon and " " .. (getStatusText(context) or "") .. " " or ""

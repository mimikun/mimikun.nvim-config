...
function sd:layout_float(opt)
  ...
  local close_autocmds = { "CursorMoved", "CursorMovedI", "InsertEnter", "BufDelete", "WinScrolled" }
...
function sd:write_line(message, severity, virt_line, srow, erow)
  ...
  nvim_buf_add_highlight(self.bufnr, 0, "Diagnostic" .. vim.diagnostic.severity[severity], srow, 0, -1)

...
function term:open_float_terminal(args)
  ...
  local cmd = (#args > 0 and args[1]) and args[1] or (require("lspsaga.util").iswin and "cmd.exe" or os.getenv("SHELL"))
  ...
  ctx.term_bufnr, ctx.term_winid =
    win:new_float(float_opt, true, true):bufopt("bufhidden", "hide"):winhl("TerminalNormal", "TerminalBorder"):wininfo()

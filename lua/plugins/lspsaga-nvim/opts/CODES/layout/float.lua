...
function M.right(left_winid, opt)
  ...
  local right_spaces = vim.o.columns - wincol - original.width - (is_ten and original.col or original.col[false])
  ...
  if opt.title then
    win_conf.title = #opt.title > win_conf.width and opt.title:sub(#opt.title - win_conf.width - 5, #opt.title)
      or opt.title
